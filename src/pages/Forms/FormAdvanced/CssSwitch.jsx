      ...
      <React.Fragment>
        <Row>
          <Col lg="12">
            <Card>
              <CardBody>
                <h4 className="card-title">Css تعویض</h4>
                <p className="card-title-desc">
                  در اینجا چند نوع سوئیچ آورده شده است{" "}
                </p>

                <Row>
                  <Col lg="6">
                    <h5 className="font-size-14 mb-3">نمونه تغییر</h5>
                    <div>
                      <Switch
                  ...
                  <Col lg="6">
                    <div className="mt-4 mt-lg-0">
                      <h5 className="font-size-14 mb-3">تغییر مربعی</h5>
