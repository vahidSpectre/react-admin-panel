...
const EcommerceProducts = () => {
  ...
  //meta title
  document.title = "Products | Skote - قالب مدیریتی و داشبورد Vite React ";
  ...
  const filterClothes = [
    { id: 1, name: "تیشرت", link: "#" },
    { id: 2, name: "پیراهن", link: "#" },
    { id: 3, name: "شلوار", link: "#" },
    { id: 4, name: "ژاکت", link: "#" },
  ];
        ...
        <Container fluid>
          ...
          <Row>
            <Col lg={3}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">فیلتر</CardTitle>
                  <div>
                    <h5 className="font-size-14 mb-3">لباس ها</h5>
                    <ul className="list-unstyled product-list">
                      {(filterClothes || [])?.map((cloth, key) => (
                        <li key={"_li_" + key}>
                          <Link to={cloth.link}>
                            <i className="mdi mdi-chevron-left me-2" />{" "}
                            {cloth.name}
                          </Link>
                        </li>
                      ))}
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="font-size-14 mb-3">قیمت</h5>
                    <br />
                    <RangeSlider
                      min={0}
                      max={600}
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="font-size-14 mb-3">تخفیف</h5>
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="font-size-14 mb-3">رتبه بندی مشتریان</h5>
                    <div>
                      <FormGroup check className="mt-2">
                        ...
                        <Label check htmlFor="productratingCheck1">
                          4 <i className="bx bx-star text-warning" /> به بالا
                        </Label>
                      </FormGroup>
                      <FormGroup check className="mt-2">
                        <Input
                        ...
                        <Label check htmlFor="productratingCheck2">
                          3 <i className="bx bx-star text-warning" /> به بالا
                        </Label>
                      </FormGroup>
                      <FormGroup check className="mt-2">
                        <Input
                        ...
                        <Label check htmlFor="productratingCheck3">
                          2 <i className="bx bx-star text-warning" /> به بالا
                        </Label>
                      </FormGroup>
                      <FormGroup check className="mt-2">
                        <Input
