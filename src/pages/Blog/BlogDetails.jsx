...
const BlogDetails = () => {
  //meta title
  document.title = "Blog Details | Skote - قالب مدیریتی و داشبورد Vite React ";
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="بلاگ" breadcrumbItem="جزئیات وبلاگ" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                      ...
                      <div className="col-xl-8">
                        <div>
                          <div className="text-center">
                            ...
                            <h4>روز زیبا با دوستان</h4>
                            <p className="text-muted mb-4">
                              <i className="mdi mdi-calendar me-1"></i> 10 آبان,
                              1402
                            </p>
                          </div>
                            ...
                            <Row>
                              <Col sm={4}>
                                <div>
                                  ...
                                  <h5 className="font-size-15">پروؤه ها</h5>
                                </div>
                              </Col>
                              <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                  <p className="text-muted mb-2">تاریخ</p>
                                  <h5 className="font-size-15">10 مهر, 1402</h5>
                                </div>
                              </Col>
                              <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                  <p className="text-muted mb-2">ارسال توسط</p>
                                ...
                                <div className="d-flex">
                                  ...
                                  <div>
                                    <p className="mb-0">
                                      ...
                                      در ارائه راهکارها و شرایط سخت تایپ به
                                      پایان رسد
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <div className="col-lg-4 col-sm-6">
                                      <div>
                                        <ul className="ps-4">
                                          ...
                                          <li className="py-1">
                                            گفتگو درباره رویداد های این هفته
                                          </li>
                                        </ul>
                                      </div>
                                    </div>
                                  ...
                                  <div className="flex-grow-1">
                                    ...
                                    <div>
                                      <Link to="#" className="text-success">
                                        <i className="mdi mdi-reply"></i> پاسخ
                                      </Link>
                                    </div>
                                  </div>
                                </div>
