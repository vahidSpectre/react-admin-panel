          ...
          <div className="d-flex flex-column h-100">
              ...
              <div className="mb-3">
                <UncontrolledDropdown>
                  <DropdownToggle className="btn btn-light w-100" type="button">
                    <i className="mdi mdi-plus me-1"></i> ایجاد
                  </DropdownToggle>
                  <DropdownMenu>
                    <DropdownItem href="#">
                      <i className="bx bx-folder me-1"></i> پوشه
                    </DropdownItem>
                    <DropdownItem href="#">
                      <i className="bx bx-file me-1"></i> فایل
                    </DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
              </div>
            ...
            <div className="mt-auto">
              ...
              >
                ...
                <div>
                  <h5 className="text-success">ویژگی های ارتقا</h5>
                  <p>اضافه شدن قابلیت های شگفت انگیز به پنل کاربری</p>
                  <div className="text-center">
                    <button
                      type="button"
                      className="btn btn-link text-decoration-none text-success"
                    >
                      ارتقا <i className="mdi mdi-arrow-left"></i>
                    </button>
                  </div>
                </div>
              </UncontrolledAlert>
