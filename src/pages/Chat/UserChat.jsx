            ...
            <div className="w-100 user-chat">
                <Card>
                        ...
                        <Row>
                            <Col md={4} xs={9}>
                                ...
                                <p className="text-muted mb-0">
                                    ...
                                    />
                                    {Chat_Box_User_Status === "آنلاین" ? "اکنون فعال است" : "آفلاین"}
                                </p>
                            </Col>
                            <Col md={8} xs={3}>
                                <ul className="list-inline user-chat-nav text-end mb-0">
                                    <li className="list-inline-item d-none d-sm-inline-block">
                                        <Dropdown className="me-1" isOpen={search_Menu} toggle={toggleSearch}>
                                            ...
                                            <DropdownMenu className="dropdown-menu-md" end={+true}>
                                                <Form className="p-3">
                                                    <FormGroup className="m-0">
                                                        <InputGroup>
                                                            <Input type="text" placeholder="جستجو ..." id="searchMessage" aria-label="Recipient's username" onChange={handelSearch} />
                                    ...
                                    <li className="list-inline-item d-none d-sm-inline-block">
                                        <Dropdown isOpen={settings_Menu} toggle={toggleSettings} className="me-1">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownItem href="#">بی صدا شده</DropdownItem>
                    ...
                    <div>
                                                                    ...
                                                                    >
                                                                        <div className="conversation-list">
                                                                            <UncontrolledDropdown>
                                                                                ...
                                                                                <DropdownMenu>
                                                                                    <DropdownItem onClick={(e) => copyMsg(e.target)} href="#"> کپی</DropdownItem>
                                                                                    <DropdownItem href="#"> ذخیره</DropdownItem>
                                                                                    <DropdownItem href="#"> بارارسال</DropdownItem>
                                                                                    <DropdownItem onClick={() => toggle_deleMsg(userMsg.id)} href="#"> حذف</DropdownItem>
                                                                                </DropdownMenu>
                                                                            </UncontrolledDropdown>
                                                                            <div className="ctext-wrap">
                                                                                <div className="conversation-name">
                                                                                    {userMsg.to_id === 1 ? message.sender : "شما"}
                                                                                </div>
                                                                                <p>{userMsg.msg}</p>
                        ...
                        {copyMsgAlert && <UncontrolledAlert color='warning' role="alert">پیام کپی شد</UncontrolledAlert>}
                            ...
                            <Row>
                                <Col>
                                    <div className="position-relative">
                                        <Input type="text" value={curMessage} onKeyPress={onKeyPress} onChange={e => { setCurMessage(e.target.value); setDisable(true) }} className="chat-input" placeholder="پیام را وارد کنید ..." />
