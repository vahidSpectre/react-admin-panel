                ...
                <div >
                        ...
                        <div className="d-flex">
                            ...
                            <div className="flex-grow-1">
                                ...
                                <p className="text-muted mb-0">
                                    <i className="mdi mdi-circle text-success align-middle me-2" /> فعال
                                </p>
                            </div>
                            ...
                            <div>
                                <Dropdown isOpen={menu1} toggle={() => setMenu1(!menu1)} className="chat-noti-dropdown active">
                                    ...
                                    <DropdownMenu className="dropdown-menu-end">
                                        ...
                                        <DropdownItem href="#">اقدامت دیگر</DropdownItem>
                    ...
                    <div className="search-box chat-search-box py-4">
                        <div className="position-relative">
                            <Input onKeyUp={searchUsers} id="search-user" type="text" placeholder="جستجو ..." onChange={searchUsers} />
                    ...
                    <div className="chat-leftsidebar-nav">
                        ...
                        <TabContent activeTab={activeTab} className="py-4">
                            <TabPane tabId="chat">
                                <div>
                                    <h5 className="font-size-14 mb-3">اخیر</h5>
                                    <ul className="list-unstyled chat-list position-relative" id="recent-list">
                                        {
                                            isLoading ? <Spinners setLoading={setLoading} /> :
                                                <SimpleBar style={{ height: "410px" }}>
                                                    {(chats || [])?.map((chat) => (
                                                        <li key={chat.id + chat.status} className={currentRoomId === chat.roomId ? "فعال" : ''}>
                                                            <Link to="#" onClick={() => userChatOpen(chat)}>
                                                                <div className="d-flex">
                                                                    <div className="align-self-center me-3">
                                                                        <i className={`mdi mdi-circle font-size-10 ${chat.status === "آنلاین" ? "text-success" : chat.status === "حد واسط" ? "text-warning" : ""}`} />
                                                                    </div>
                            ...
                            <TabPane tabId="groups">
                                <h5 className="font-size-14 mb-3">گروه ها</h5>
                            ...
                            <TabPane tabId="contacts">
                                <h5 className="font-size-14 mb-3">مخاطبین</h5>
                                <div>
                                    <SimpleBar style={{ height: "410px" }}>
                                        {contacts &&
