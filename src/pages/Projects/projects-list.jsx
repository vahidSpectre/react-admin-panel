...
const ProjectsList = () => {
  //meta title
  document.title = "Project List | Skote - قالب مدیریتی و داشبورد react";
            ...
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                <DropdownItem href="#!" onClick={() => handleProjectClick(cellProps.row.original)}>
                  <i className="mdi mdi-pencil font-size-16 text-success me-1" />ویرایش
                </DropdownItem>
                <DropdownItem href="#!" onClick={() => onClickDelete(cellProps.row.original)}>
                  <i className="mdi mdi-trash-can font-size-16 text-danger me-1" />حذف
                </DropdownItem>
              </DropdownMenu>
            </UncontrolledDropdown>
          );
