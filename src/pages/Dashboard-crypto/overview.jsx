...
const Oerview = ({ dataColors }) => {
  ...
  const updateChartMonthly = () => {
    var newxaxis = {
      min: new Date("28 خرداد 1402").getTime(),
      max: new Date("27 مهر 1402").getTime(),
    };
  ...
  const updateChartSixMonth = () => {
    var newxaxis = {
      min: new Date("27 مهر 1400").getTime(),
      max: new Date("27 ابان 1400").getTime(),
    };
    const modifiedOptions = {
      ...options,
      xaxis: newxaxis,
  ...
  const updateChartYearly = () => {
    var newxaxis = {
      min: new Date("27 خرداد 1401").getTime(),
      max: new Date("27 خرداد 1401").getTime(),
    };
    const modifiedOptions = {
      ...options,
      xaxis: newxaxis,
