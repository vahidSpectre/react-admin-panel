              ...
              {props.checkbox && (
                <div className="btn-toolbar" role="toolbar">
                  ...
                  >
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                      <DropdownItem to="#">بروزرسانی ها</DropdownItem>
                  ...
                  >
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                      ...
                      <DropdownItem to="#">افزودن به عنوان ستاره دار</DropdownItem>
            ...
            <div className="search-box mb-2 me-2">
              <div className="position-relative">
                <input
                  ...
                  placeholder="جستجو..." onChange={(e) => props.handelSearch(e.target.value)} />
